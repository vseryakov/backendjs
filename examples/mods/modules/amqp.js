...
util.inherits(AmqpClient, Client);
...
AmqpClient.prototype.pollQueue = function(options)
{
...
AmqpClient.prototype.subscribeQueue = function(options, callback)
{
    if (!this.channel) return;
...
AmqpClient.prototype.unsubscribeQueue = function(options, callback)
{
    Client.prototype.unsubscribeQueue.call(this, options, callback);
    if (this.channel && this.tag) this.channel.cancel(this.tag);
}

AmqpClient.prototype.publishQueue = function(msg, options, callback)
{
    if (this.channel) {
        var chan = this.channel(options);
