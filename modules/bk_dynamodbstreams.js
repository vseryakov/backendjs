...
const mod = {
    args: [
        ...
        { name: "retry-timeout-([a-z0-9_]+)", type: "int", obj: "retryTimeouts", strip: /retry-timeout-/, nocamel: 1, descr: "Min timeout in ms between retries on empty records by table, exponential backoff is used" },
        { name: "retry-count-([a-z0-9_]+)", type: "int", obj: "retryCounts", strip: /retry-count-/, nocamel: 1, descr: "Number of times to read records from an open shard with no records by table" },
    ],
    jobs: [],
    running: [],
    options: {
