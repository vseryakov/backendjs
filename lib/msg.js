...
function Msg()
{
    ...
    this.args = [
             ...
             { name: "([^-]+)-authkey-([^-]+)-(.+)", obj: "config", make: "$1@$3-$2|_authkey", nocamel: 1, descr: "A auth key for APN in p8 format, can be a file name with .p8 extension or a string with the key contents encoded with base64, the format is: -msg-apn-authkey-TEAMID-KEYID KEYDATA" },
