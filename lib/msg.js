...
function Msg()
{
    ...
    this.args = [
             ...
             { name: "([^-]+)-authkey-([^-]+)-(.+)", obj: "config", make: "$1.$3|$2", nocamel: 1, descr: "A auth key for APN in p8 format, can be a file name with .p8 extension or a string with the key contents encoded with base64" },
             ...
             { name: "app-team-(.+)", obj: "team", make: "$1", type: "regexp", nocamel: 1, descr: "Regexp that identifies all app bundles for a team" },
             { name: "app-team", descr: "Default team to use for apps that do not match any specific teams" },
         ];
    this.config = {};
    this.dependency = {};
    this.team = {};
