...
Msg.prototype.shutdown = function(options, callback)
{
    ...
    setTimeout(() => {
        lib.forEach(this.modules, (client, next) => { client.close(next) }, callback);
    }, timeout);
}
