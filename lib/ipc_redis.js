...
IpcRedisClient.prototype.subscribe = function(key, options, callback, data)
{
...
IpcRedisClient.prototype.unsubscribe = function(key, options)
{
    Client.prototype.unsubscribe.call(this, key, options);
    this.client.punsubscribe(key);
}

IpcRedisClient.prototype.publish = function(key, data, options, callback)
{
