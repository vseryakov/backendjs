...
{
    this.client.info(function(e,v) { callback(v); });
}
...
IpcRedisClient.prototype.incr = function(key, val, options)
{
    this.client.incr(key, val, lib.noop);
}
...
IpcRedisClient.prototype.publish = function(key, data)
{
