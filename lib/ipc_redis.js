...
{
    var self = this;
    this.client.eval(client.scripts.limiter, 5, options.name, options.rate, options.max, options.interval, Date.now(), Math.ceil(options.ttl/1000), function(err, delay) {
