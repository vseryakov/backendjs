...
IpcRedisClient.prototype.keys = function(options, callback)
{
    this.client.keys((options && options.name) || "*", function(e,v) {
        callback(v);
    });
}

IpcRedisClient.prototype.clear = function(options)
{
