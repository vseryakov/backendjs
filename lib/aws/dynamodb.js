 ...
 * ddbUpdateItem("users", { id: 1, name: "john" }, { gender: 'male', icons: '1.png' }, { ops: { icons: 'incr' }, query: { id: null } })
 * ddbUpdateItem("users", { id: 1, name: "john" }, { gender: 'male', icons: '1.png', num: 1 }, { ops: { num: 'add', icons: 'add' }, query: { id: null, num: 0 }, ops: { num: "gt" } })
 * @memberOf module:aws
