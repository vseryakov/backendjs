...
/**
 * AWS EC2 API request, async version
 * @memberof module:aws
 * @method aqueryEC2
 * @async
 */
aws.aqueryEC2 = async function(action, obj, options)
{
...
aws.ec2RunInstances = function(options, callback)
{
    ...
    if (options.launchTemplate) {
        ...
        var groups = lib.split(options.groupId || this.groupId, null, { unique: 1 });
        var subnetId = lib.split(options.subnetId || this.subnetId)[0];
