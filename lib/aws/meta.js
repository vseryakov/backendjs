 ...
 * running `-app-run-mode production` and `-app-run-mode dev` will use different config files</caption>
 *
 * # local config pointing to S3 config bkjs.conf
 * aws-config-s3-file = s3://mybucket/config/bkjs-@runMode@.conf
 *
