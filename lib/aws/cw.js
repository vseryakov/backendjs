...
// - age - number of minutes to go back in case start_time is not specified, fraction can be used, default is 30mins if no timestamp are given
...
//    }
//
// Returns an object: { data: [{ id, label, data: [[x,y],...] }], errors: [] }
//
// Example:
//
...
aws.cwGetMetricData = function(options, callback)
{
    ...
    var start = lib.toDate(options.start_time || (Date.now() - lib.toNumber(options.age, { min: 1 }) * 60000));
