...
Pool.prototype.convertError = function(table, op, err, options)
{
    ...
    case "del":
        ...
        break;
    case "select":
        if (err.messsage === "The provided starting key is outside query boundaries based on provided conditions") err.code = "NotMatched";
        break;
    }
...
Pool.prototype.queryBulk = function(client, req, callback)
{
    ...
    req.options.ReturnConsumedCapacity = "TOTAL";
    var count = lib.toClamp(req.options.bulkCount || 25, 2, cap.writeCapacity || 25);
