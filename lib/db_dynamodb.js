    ...
    ["","1","2","3","4","5"].forEach(function(n) {
        ...
        idx.forEach(function(x) {
            ...
            add.projection = Object.keys(req.obj).filter(function(y, i) {
                return (req.obj[y].projections && !Array.isArray(req.obj[y].projections)) ||
...
Pool.prototype.queryList = function(client, req, callback)
{
    ...
    // Capacity rate limiter
    if (req.options.useCapacity > 0 || req.options.capacity || req.options.factorCapacity) {
