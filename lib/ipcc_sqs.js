...
IpcSQSClient.prototype.submit = function(job, options, callback)
{
    ...
    if (options && (options.region || options.delay || options.group || options.unique)) {
        opts = lib.objClone(this.options, "region", options.region, "delay", options.delay, "group", options.group, "unique", options.unique);
    }
