...
class CacheClient extends EventEmitter {
     ...
     * @param {function} [callback]
     */
    put(_key, _val, _options, callback) {
        lib.tryCall(callback);
    }
     ...
     * @param {function} [callback]
     */
    incr(_key, _val, _options, callback) {
    ...
    unlock(_name, _options, callback) {
        lib.tryCall(callback);
    }
