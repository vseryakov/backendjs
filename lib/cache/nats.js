...
NatsClient.prototype.applyOptions = function(options)
{
...
NatsClient.prototype.close = function()
{
...
NatsClient.prototype.subscribe = function(channel, options, callback)
{
...
NatsClient.prototype.unsubscribe = function(channel, options, callback)
{
...
NatsClient.prototype.publish = function(channel, msg, options, callback)
{
...
NatsClient.prototype.subscribeQueue = function(options, callback)
{
...
NatsClient.prototype.unsubscribeQueue = function(options, callback)
{
...
NatsClient.prototype.publishQueue = function(job, options, callback)
{
...
NatsClient.prototype.pollQueue = function(options)
{
    var sub = this.canonical(options);
...
NatsClient.prototype._callback = function(options, err, jsmsg)
{
    var sub = this.canonical(options);
