...
var api = {
    ...
    args: [{ name: "images-url", descr: "URL where images are stored, for cases of central image server(s), must be full URL with optional path" },
           ...
           { name: "allow-include-authenticated", type: "list", descr: "Include rules from the named `-allow-account-` params to the allow ccheks of the authenticated users" },
           ...
           { name: "allow-account-([a-z0-9_]+)", type: "regexpobj", obj: "allow-account", descr: "Add URLs which can be accessed by specific account type only, can be partial urls or Regexp" },
           { name: "allow-include-([a-z0-9_]+)", type: "rlist", obj: "allow-include", descr: "Combine multiple allow-account regexps for the specified role, this is for reusing same regexp rules for multiple roles" },
           ...
           { name: "deny-include-authenticated", type: "list", descr: "Include rules from the named `deny-account-` params to the deny checks of the authenticated users" },
           ...
           { name: "deny-include-([a-z0-9_]+)", type: "list", obj: "deny-include", descr: "Combine multiple deny-account regexps for the specified role, this is for reusing same regexp rules for multiple roles" },
    ...
    allowAnonymous: {},
    allowAuthenticated: {},
    allowIncludeAuthenticated: [],
    denyAccount: {},
    denyInclude: {},
    denyAuthenticated: {},
    denyIncludeAuthenticated: [],
