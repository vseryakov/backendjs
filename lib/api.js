...
api.init = function(options, callback)
{
    ...
    this.app.use(function(req, res, next) {
        ...
        if (logger.level >= logger.DEBUG) logger.debug('serverRequest:', core.port, req.options.ip, req.connection.remoteAddress, req.method, req.options.path, req.get('content-type'), req.get(self.appHeaderName), req.get(self.signatureHeaderName), req.get(self.tzHeaderName), req.get("x-forwarded-for"));
