...
var api = {
    ...
    args: [{ name: "images-url", descr: "URL where images are stored, for cases of central image server(s), must be full URL with optional path" },
           ...
           { name: "allow-acl-authenticated", type: "list", descr: "Include rules from the named `-allow-account-` params to the allow ccheks of the authenticated users" },
           ...
           { name: "allow-acl-([a-z0-9_]+)", type: "rlist", obj: "allow-acl", descr: "Combine multiple allow-account regexps for the specified role, this is for reusing same regexp rules for multiple roles" },
           ...
           { name: "deny-acl-authenticated", type: "list", descr: "Include rules from the named `deny-account-` params to the deny checks of the authenticated users" },
           ...
           { name: "deny-acl-([a-z0-9_]+)", type: "list", obj: "deny-acl", descr: "Combine multiple deny-account regexps for the specified role, this is for reusing same regexp rules for multiple roles" },
    ...
    allowAnonymous: {},
    allowAuthenticated: {},
    allowAclAuthenticated: [],
    denyAccount: {},
    denyAcl: {},
    denyAuthenticated: {},
    denyAclAuthenticated: [],
    acl: {},
