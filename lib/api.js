...
const api = {
    ...
    args: [
        ...
        { name: "cleanup-rules-(.+)", obj: "cleanupRules.$1", type: "map", datatype: "auto", merge: 1, nocamel: 1, descr: "Rules for the cleanupResult per table, ex. api-cleanup-rules-bk_user=email:0,phone:1" },
