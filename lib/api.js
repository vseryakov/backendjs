...
const api = {
    ...
    args: [
        ...
        { name: "allow-acl-authenticated", type: "list", descr: "Combine regexps from the specified acls to allow access by any authenticated user account, this is only checked if no other acls matched" },
