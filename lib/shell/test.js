...
shell.testJob = function(options, callback)
{
    ...
    if (options.rand) return setTimeout(callback, lib.randomInt(0, options.rand), options.err);
    if (options.timeout) return setTimeout(callback, options.timeout, options.err);
