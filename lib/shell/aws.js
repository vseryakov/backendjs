...
shell.awsSearchImages = function(options, callback)
{
    ...
    if (options.owner) {
        var owner = lib.split(options.owner);
...
shell.commands.awsShowLogs = function(options, callback)
{
    var name = shell.getArg("-name", options);
    if (!name) return shell.exit("ERROR: -name is required");
...
shell.commands.awsCreateQueue = function(options, callback)
{
    var name = shell.getArg("-name", options);
    if (!name) return shell.exit("ERROR: -name is required");
    ...
    lib.series([
        ...
        function(next, rc) {
            ...
            db.select("bk_config", { type, name }, (err, rows) => {
                var row = rows?.at(-1);
...
shell.commands.awsShowCert = function(options, callback)
{
...
shell.commands.awsListCert = function(options, callback)
{
...
shell.commands.awsManageCert = function(options, callback)
{
    var arn = shell.getArg("-arn", options);
    if (!arn) return shell.exit("ERROR: -arn is required");
...
shell.commands.awsCreateCert = function(options, callback)
{
...
shell.commands.awsDelCert = function(options, callback)
{
    var arn = shell.getArg("-arn", options);
    if (!arn) return shell.exit("ERROR: -arn is required");
    if (!arn.includes(":")) arn = `arn:aws:acm:${aws.region}:${aws.accountId}:certificate/${arn}`;
...
shell.commands.awsSetRoute53 = function(options)
{
    ...
    lib.series([
        ...
        function(next) {
            var host = lib.toTemplate(name, app.instance);
            if (current) {
...
shell.commands.awsListRoute53 = function(options)
{
