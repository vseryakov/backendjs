...
shell.help.push("-aws-set-route53 -domain HOSTNAME [-current] [-filter PATTERN] [-type A|CNAME] [-ttl N] [-op OP] [-alias A] [-value IPS] [-public] [-dry-run] - create/update/delete a Route53 record of specified type with IP/hostnames of all instances that satisfy the given filter, -public makes it use public IP/hostnames");
...
shell.cmdAwsSetRoute53 = function(options)
{
    ...
    lib.series([
        ...
        function(next) {
            ...
            var rr = { op: op, name: host, type: type, ttl: ttl, value: values, alias: alias }
