...
{
    var appName = shell.getArg("-app-name", options, app.appName);
    var appVersion = shell.getArg("-app-version", options, app.appVersion);
    ...
    lib.series([
        function(next) {
            ...
            var req = {
                ...
                SubjectAlternativeNames: lib.split(shell.getArg("-domains", options)),
            };
            if (shell.isArg("-star")) {
                req.SubjectAlternativeNames.push("*." + domain);
            }
