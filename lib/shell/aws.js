    ...
    lib.series([
        function(next) {
            var req = {
                ...
                desiredStatus: shell.getArg("-status", options),
                family: shell.getArg("-family", options),
                serviceName: shell.getArg("-service", options),
                startedBy: shell.getArg("-startedby", options),
                nextToken: shell.getArg("-token", options),
            };
