...
Pool.prototype.query = function(client, req, options, callback)
{
    ...
    case "get":
        path = req.table + "/" + docType + "/" + lib.escape(this._getKey(keys, req.obj));
    ...
    case "incr":
    case "update":
        path = req.table + "/" + docType + "/" + lib.escape(this._getKey(keys, req.obj)) + "/_update";
        query = this._getQuery("index", req.options);
