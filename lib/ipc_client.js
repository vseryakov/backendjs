...
IpcClient.prototype.subscribeQueue = function(options, callback)
{
    ...
    this._listeners++;
    if (!this._pollingQueue) {
        this._pollingQueue = 1;
        this.schedulePollQueue();
    }
}
...
IpcClient.prototype.unsubscribeQueue = function(options, callback)
{
    ...
    if (this._pollingQueue && !this._listeners) {
        this._pollingQueue = 0;
    }
}
...
IpcClient.prototype.pollQueue = function()
{
}
...
IpcClient.prototype.schedulePollQueue = function(timeout)
{
    if (!this._pollingQueue) return;
    ...
    if (timeout > 0) {
        setTimeout(this.pollQueue.bind(this), timeout);
    } else {
        setImmediate(this.pollQueue.bind(this));
    }
}
...
IpcClient.prototype.isPollingQueue = function()
{
    return this._pollingQueue;
}
