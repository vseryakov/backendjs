...
// Subscribe to receive notification for events sarting with the specified key, `data` will be passed to the callback as the first argument
IpcClient.prototype.subscribe = function(key, options, callback, data)
{
    this.callbacks[key] = [ callback, data ];
}

// Stop receiving notifictions for th give key
IpcClient.prototype.unsubscribe = function(key, options)
{
    delete this.callbacks[key];
}

// Publish an event
IpcClient.prototype.publish = function(key, data, options, callback)
{
