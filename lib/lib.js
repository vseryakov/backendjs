...
lib.toDate = function(val, dflt, invalid)
{
    ...
    return this.isDate(d) ? d : invalid || isNaN(dflt) || dflt === null || dflt === 0 ? null : new Date(dflt || 0);
}
...
// Same as `lib.series` but all functions will be called with errors passed to the next task, only the last passederror will be returned
//
//          lib.everySeries([
//             function(next, err) {
...
lib.strftime = function(date, fmt, options)
{
    ...
    var handlers = {
        ...
        W: function(t) { return zeropad(lib.weekOfYear(t, utc)) },
