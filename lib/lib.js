...
lib.toTemplate = function(text, obj, options)
{
    ...
    while (str) {
        ...
        if (options && Array.isArray(options.allow) && options.allow.indexOf(tag) == -1) continue;
        if (options && Array.isArray(options.skip) && options.skip.indexOf(tag) > -1) continue;
        if (options && Array.isArray(options.only) && options.only.indexOf(tag) == -1) continue;
