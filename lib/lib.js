...
lib.objSet = function(obj, name, value, options)
{
    ...
    return options && options.val ? obj[p] : v;
}

// Increment a property by the specified number, if the property does not exist it will be created, returns new incremented value. It uses `objSet`
// so the property name can be a nested path.
lib.objIncr = function(obj, name, count)
{
    return this.objSet(obj, name, count, { incr: 1, val: 1 });
}
