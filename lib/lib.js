...
{
    if (typeof obj == "function") return obj(method, ...args);
    if (typeof obj != "object") return;
    if (typeof method == "function") return method.call(obj, ...args);
    if (typeof obj[method] == "function") return obj[method].call(obj, ...args);
}
...
{
    return this.inspect(err || "", { ignore: /^domain|req|res$/ }) + " " + (util.types.isNativeError(err) && err.stack ? err.stack : "");
}
