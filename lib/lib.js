...
lib.strftime = function(date, fmt, options)
{
    ...
    var handlers = {
        a: function(t) { return [lib.__({ phrase: "Sun", locale: lang }),
                                 ...
                                 lib.__({ phrase: "Sat", locale: lang }) ][utc ? t.getUTCDay() : t.getDay()] },
        A: function(t) { return [lib.__({ phrase: "Sunday", locale: lang }),
                                 ...
                                 lib.__({ phrase: "Saturday", locale: lang }) ][utc ? t.getUTCDay() : t.getDay()] },
        b: function(t) { return [lib.__({ phrase: "Jan", locale: lang }),
                                 ...
                                 lib.__({ phrase: "Dec", locale: lang }) ][utc ? t.getUTCMonth() : t.getMonth()] },
        B: function(t) { return [lib.__({ phrase: "January", locale: lang }),
                                 ...
                                 lib.__({ phrase: "December", locale: lang }) ][utc ? t.getUTCMonth() : t.getMonth()] },
