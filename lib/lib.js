...
{
    var excl = lib.isArray(options.nopids) ? lib.toRegexp("^\\/proc\\/(" + options.nopids.join("|") + ")$") : null;
    lib.findFile("/proc", { include: /^\/proc\/[0-9]+$/, exclude: excl, depth: 0, base: 1 }, (err, files) => {
        if (!err) {
