...
{
    return this.status == 529 || this.status == 500 || this.status == 503 || this.data.match(/(ProvisionedThroughputExceededException|ThrottlingException|SerializationException|UnrecognizedClientException)/)
}
