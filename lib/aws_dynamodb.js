...
aws.queryDDB = function (action, obj, options, callback)
{
    ...
    core.httpGet(uri, opts, function(err, params) {
        ...
        if (params.status != 200) {
            ...
            logger[opts.quiet || err.code == "ConditionalCheckFailedException" ? "debug" : "error"]('queryDDB:', action, obj, params.data, "token:", aws.key, aws.tokenExpiration, params.headers.Authorization);
        } else {
