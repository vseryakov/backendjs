...
const mod = {
    ...
    args: [
        ...
        { name: "passkey-domain", obj: "passkey", type: "bool", descr: "Use domain only for passkeys" },
        { name: "passkey-path", obj: "passkey", descr: "Endpoint path for passkeys" },
        { name: "passkey-ttl", obj: "passkey", type: "int", descr: "TTL for passkey challenges" },
    ],
    table: "bk_user",
    sigversion: -1,
    hash: "bcrypt",
