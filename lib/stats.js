...
const mod = {
    ...
    columns: {
        ...
        api_200_count: { type: "number", label: "API requests with 200 status" },
        api_400_count: { type: "number", label: "API requests with 200 status" },
        api_401_count: { type: "number", label: "API requests with 200 status" },
        api_403_count: { type: "number", label: "API requests with 200 status" },
        api_404_count: { type: "number", label: "API requests with 200 status" },
        api_bad_count: { type: "number", label: "API requests with 4XX status" },
        api_err_count: { type: "number", label: "API requests with 5XX status" },
        api_large_count: { type: "number", label: "API requests with too large status" },
        ...
        cache_default_req_count: { type: "number", label: "Cache request count" },
        ...
        queue_default_req_count: { type: "number", label: "Queue jobs count" },
        ...
        db_dynamodb_default_read_count: { type: "number", label: "DB pool table read count" },
        db_dynamodb_default_read_rate: { type: "number", label: "DB pool table read rate" },
        db_dynamodb_default_write_count: { type: "number", label: "DB pool table write count" },
        db_dynamodb_default_wrtie_rate: { type: "number", label: "DB pool table write rate" },
    },
    roles: [],
};
module.exports = mod;
