...
/**
 * Shell functions must follow the naming convention is `shell.cmdMyCommand`, where `MyCommand` is the command name in camel case
 *
 * @typedef {function} ShellCommand
 ...
 *
 * shell.cmdMyCommand = function(options) {
 *    console.log("hello");
 *    return "continue"
 * }
