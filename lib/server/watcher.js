...
const mod = {
    ...
    args: [
        ...
        { name: "web", type: "list", array: 1, descr: "List of directories to be watched for file modifications and execute a `build-web` command to produce bundles, apps, etc... Relative paths will be applied to all packages, example: web/js,web/css" },
...
mod.start = function()
{
    if (core.repl.watchPort) {
        core.startRepl(core.repl.watchPort, core.repl.bind);
    }
    ...
    if (this.build) {
        ...
        logger.info('startWatcher:', "build:", this.build, "web:", String(webdirs), String(this.match), String(this.ignore));
