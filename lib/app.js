...
module.exports = {
    ...
    args: [
        ...
        { name: "log-inspect", type: "callback", callback: "setLogInspect", descr: "Install custom logger inspector instead of util.inspect: 'json' - JSON output, 1|true - lib.inspect, 0 - util.inspect" },
    ...
    /** @var {AsyncLocalStorage} - async storage to be used by other modules for tracking async flow */
    async_storage: null,
};
...
app.init = function(options, callback)
{
    ...
    this.async_storage = this.async_storage || new async_hooks.AsyncLocalStorage();
