...
module.exports = {
    ...
    args: [
        ...
        { name: "log-filter", type: "callback", callback: function(v) { if (v) logger.setDebugFilter(v) }, descr: "Enable debug filters, format is: label,... to enable, and !label,... to disable. First 2 arguments are used by debug filter in logger.debug", pass: 1, example: "//To log all debugging api and queries: as first/second args\napp-log-filter = api,query:" },
        ...
        { name: "no-([a-z]+)", type: "callback", callback: function(_v,o) { lib.toFlags("add", this.none, o.name) }, strip: "no-", nocamel: 1, descr: "Do not start or disable a service, server, web, jobs, ipc, db, dbconf, watch, modules, packages, configure", pass: 1 },
        { name: "ok-(.+)", type: "callback", callback: function(_v,o) { lib.toFlags("del", this.none, o.name) }, strip: "ok-", nocamel: 1, descr: "Enable disabled service, opposite of -no", pass: 1 },
