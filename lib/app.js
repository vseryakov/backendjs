...
module.exports = {
     ...
     * @property {string} tag - Instance/container tag set manually or derived from AWS tags
     ...
     * @property {string} roles - Additional roles to use for configuration purposes
     */
    env: {
