...
module.exports = {
     ...
     * @property {string} env.image - EC2 image id
     * @property {string} env.container - ECS container name
     * @property {string} env.container_id - ECS container id
     * @property {string} env.task_id - ECS container task id
     * @property {string} env.ip - EC2/ECS private IP address
     * @property {string} env.tag - Instance/container tag set manually or derived from AWS tags
     * @property {string} env.worker_id - set from cluster.worker_id
     * @property {string} env.region - AWS region
     * @property {string} env.zone - AWS availability zone
     * @property {string} env.roles - Additional roles to use for configuration purposes
     */
    env: {
