...
const app = {
    ...
    args: [
        ...
        { name: "role", type: "callbacl", callback: function(v) { this.setRole(v) }, descr: "Override primary server role" },
 ...
 * @property {string} role - the primary proccess role, one of: `node, watcher, server, web, worker`
