 ...
 * @property {boolean} [sametype] - only set new value to non-existing or existing property of the same type, to prevent overriding existing properties
 */
...
module.exports = {
    ...
    args: [
        ...
        { name: "env-([a-z0-9_-]+)", obj: 'env', make: "$1", camel: "-", autotype: { roles: "list" }, descr: "Set runtime env properties explicitly: tag, region, zone, roles, ...", pass: 1, example: "app-env-roles = dev,web\napp-env-tag = api" },
        ...
        { name: "no-([a-z]+)", type: "callback", callback(_v,o) { lib.arrayUpdate("add", this.none, o.name) }, strip: "no-", nocamel: 1, descr: "Do not start or disable a service, server, web, jobs, ipc, db, dbconf, watch, modules, packages, configure", pass: 1 },
        { name: "ok-(.+)", type: "callback", callback(_v,o) { lib.arrayUpdate("del", this.none, o.name) }, strip: "ok-", nocamel: 1, descr: "Enable disabled service, opposite of -no", pass: 1 },
        ...
        { name: "modules-methods-(.+)", obj: "modules", make: "$1", type: "regexp", nocamel: 1, descr: "Modules that allowed to run methods by name, useful to restrict configure methods", example: "-app-modules-methods-configureMiddleware myapp", pass: 1 },
