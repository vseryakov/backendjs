 ...
 * @params {function} [callback] - callback as (err, request) where request is {FetchRequest} object combined with input params and updated fields
 *
 */
function Fetch(uri, params, callback)
{
    logger.dev("fetch:", app.role, uri, params, callback);
...
/**
 * Request object to support fetch
 ...
 * @property {boolean} sign - sign request with provided email/secret properties
...
class FetchRequest {
    ...
    onError(err, callback)
    {
        ...
        if (this.errorCount-- > 0) {
            ...
            setTimeout(Fetch.bind(null, this._uri, this, callback), lib.objMult(this, "retryTimeout", this.retryMultiplier, "old"));
