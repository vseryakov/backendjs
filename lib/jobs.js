 ...
 * ## Example:
 *
 * ### This SQS queue is shared via config file or DB between all processes
 * ```
 ...
 * -  mymod.processUsers is a job function which is run by a worker process, it can be a different host
 *
 * ```js
