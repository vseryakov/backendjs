...
module.exports = {
    ...
    properties: [
        ...
        "noRetryVisibilityTimeout", "retryVisibilityTimeout",
        "stopOnError",
        "startTime", "endTime",
 ...
 *
 * @param {int} [options.noWaitTimeout] - number of milliseconds before deleting the job for one-off jobs but taking into account the uniqueKey and visibility timeout giving time
