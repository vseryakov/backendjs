...
module.exports = {
    ...
    args: [
        ...
        { name: "worker-queue", type: "list", onupdate() { if (ipc.role==="worker"&&app.role==="worker") this.subscribeWorker()}, descr: "Queue(s) to subscribe for workers, multiple queues can be processes at the same time, i.e. more than one job can run from different queues" },
