 ...
 *
 * To rate limit by authenticated userId in addition to the path set `rate_userId` property to true.
 *
 ...
 * middleware-validate-param-*-0-/admin/* = rate:10,rate_interval:30000,rate_userId=true
 *
 * ```
 *
 * ## Fixed config mode
