...
var IpcRedisClient = require(__dirname + "/ipc_redisclient");
...
{
    if (url.match(/^redisq:/)) return new IpcRedisQueue(url, options);
}

function IpcRedisQueue(url, options)
{
    IpcRedisClient.call(this, url, options);
...
util.inherits(IpcRedisQueue, IpcRedisClient);

IpcRedisQueue.prototype.close = function()
{
    IpcRedisClient.prototype.close.call(this);
    this._monitorTimer = clearInterval(this._monitorTimer);
}

IpcRedisQueue.prototype.monitorQueue = function()
{
    var self = this;
...
IpcRedisQueue.prototype.monitor = function()
{
...
IpcRedisQueue.prototype.poller = function()
{
    var self = this;
...
IpcRedisQueue.prototype.publish = function(channel, msg, options, callback)
{
...
IpcRedisQueue.prototype.limiter = function(options, callback)
{
    var self = this;
