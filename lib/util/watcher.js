...
mod.startProcess = function()
{
    ...
    logger.log('startProcess:', app.role, 'version:', app.version, 'home:', app.home, 'port:', api.port, 'uid:', lib.getuid(), 'pid:', process.pid, 'app:', app.appName, app.runMode, app.instance);
}
