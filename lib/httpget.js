...
//   - cookies - an object with cookies to send with request
//   - setcookie - if true on return it will contain parsed cookies from the response as an object
...
HttpRequest.prototype.onEnd = function(res, callback)
{
    ...
    if (this.setcookie) this.setcookie = core.parseCookies(headers["set-cookie"]);
