...
core.setHost = function(host)
{
    if (typeof host == "string" && host) {
        this.host = host.toLowerCase();
        this.hostName = this.host.split(".")[0];
        this.domain = lib.domainName(this.host);
    }
    return this.host;
}
                        ...
                        return {
                            promise: function() {
                                return new Promise((resolve, reject) => {
                                    var body = Buffer.from(params.RawMessage.Data).toString("base64");
                                    var opts = { from: params.Source, to: params.Destinations };
                                    var method = "sesSendRawEmail";
                                    if (h.protocol == "ses2:") method += "2";
                                    core.modules.aws[method](body, opts, (err, rc) => {
...
core.createRepl = function(options)
{
    ...
    r.context.modules = core.modules;
