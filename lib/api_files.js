...
{
    if (file && this.filesUrl && this.filesRaw) return this.filesUrl + path.normalize(file);
    if (file && this.filesS3 && this.filesS3Options) {
        this.filesS3Options.url = true;
        return core.modules.aws.signS3("GET", this.filesS3, path.normalize(file), this.filesS3Options);
    }
    return "";
}
