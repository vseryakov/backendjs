...
const core = {
    ...
    logInspect: {
        ...
        length: 512,
        replace: { " ": /[\r\n\t]+/g },
        ignore: /apikey|apitoken|secret|salt|password|passwd|publickey|privatekey|passkey|authorization|signature/i,
    },
    ...
    args: [
        ...
        { name: "ssl", type: "map", obj: 'ssl', merge: 1, mapType: "auto", descr: "SSL params: port, bind, key, cert, pfx, ca, passphrase, crl, ciphers" },
        ...
        { name: "app-package", descr: "NPM package containing the application package.json, it will be added to the list of package.json files for app name and version discovery. The package must be included in the -import-packages list.", pass: 1 },
        ...
        { name: "no-([a-z]+)", type: "callback", callback: function(v,o) { lib.toFlags("add", this.none, o.name) }, strip: "no-", nocamel: 1, descr: "Do not start or disbale a service, master, web, jobs, ipc, db, dbconf, locales, watch, modules, packages, configure", pass: 1 },
        ...
        { name: "(import|preload)-packages", type: "list", array: 1, push: 1, descr: "NPM packages to load on startup, the modules, locales, viewes, web subfolders from the package will be added automatically to the system paths, modules will be loaded if present, the config file in etc subfolder will be parsed if present", pass: 1 },
...
core.init = function(options, callback)
{
    ...
    lib.series([
        ...
        function(next) {
            ...
            config += "\n" + core.loadPackages(lib.isArray(core.importPackages, core.preloadPackages));
            next();
        },
        ...
        function(next) {
            ...
            var opts = {
                ...
                include: options.includeModules || core.includeModules,
...
core.runMethods = function(name, params, options, callback)
{
    ...
    if (!this._modules) core.sortModules();
...
// This is used in the core to register all internal modules and makes it available in the shell and in the `core.modules` object.
//
...
//
// Each module is put in the top level `modules` registry or legacy `core.modules` by name, the name can
...
//
// The following properties are reserved and used by the backendjs:
// - `name` - module name
...
core.signRequest = function()
{
    ...
    var sig = core.modules.api.signature.create(this.login, this.secret, this);
    this.headers[sig.header] = sig.value;
}

require(__dirname + "/core/args")
require(__dirname + "/core/utils")
require(__dirname + "/core/sendmail")
