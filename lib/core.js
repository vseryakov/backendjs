...
const core = {
    ...
    args: [
        ...
        { name: "web", type: "callback", callback: function() { delete this.noWeb }, descr: "Start Web server process, spawn workers that listen on the same port, for use without master process which starts Web servers automatically" },
        { name: "web-master", type: "bool", descr: "Start Web server inside the master" },
        ...
        { name: "no-web", type: "bool", descr: "Disable Web server processes, without this flag Web server starts by default from the master a separate process" },
        ...
        { name: "preload-modules", type: "regexp", descr: "Modules to preload first from any modules/ folders including the system folder, this can be used to preload default bkjs system modules", pass: 1, env: "BKJS_PRELOAD_MODULES" },
