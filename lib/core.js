...
const core = {
    ...
    args: [
        ...
        { name: "build-mode", descr: "How to serialize web build launches for multiple files chnaged at the same time, if empty run one build per file ext, `dir` to run every launch per config directory, `dir1` to run by next top dir, `dir3` to run by thid directory from the file...." },
