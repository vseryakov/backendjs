...
const core = {
    ...
    args: [
        ...
        { name: "syslog", type: "callback", callback: function(v) { logger.setSyslog(v || 1, this.name) }, descr: "Log messages to syslog, pass 0 to disable, 1 or url (tcp|udp):[//host:port]/path?[facility=F][&tag=T][&retryCount=N][&rfc5424=1][&rfc3164=1]...", pass: 1 },
