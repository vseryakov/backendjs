...
const core = {
    ...
    args: [
        ...
        { name: "app-package", descr: "NPM package containing the application package.json, it will be added to the list of package.json files for app name and version discovery. The package must be included in the -use-packages list.", pass: 1 },
        ...
        { name: "use-packages", type: "list", array: 1, push: 1, descr: "NPM packages to load on startup, the modules, locales, viewes, web subfolders from the package will be added automatically to the system paths, modules will be loaded if present, the config file in etc subfolder will be parsed if present", pass: 1 },
...
core.init = function(options, callback)
{
    ...
    lib.series([
        ...
        function(next) {
            ...
            config += "\n" + core.loadPackages(core.usePackages);
            next();
        },
