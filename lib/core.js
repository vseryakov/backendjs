...
const core = {
    ...
    args: [
        ...
        { name: "host-name", type: "callback", callback: function(v) { if (!v)return; this.host=v;this.hostName=v.split(".")[0];this.domain = lib.domainName(v);this._name = "hostName" }, descr: "Hostname/domain to use for communications, default is current domain of the host machine" },
...
core.init = function(options, callback)
{
    ...
    this.location = "http://" + this.host + ":" + core.port;
