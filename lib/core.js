...
const core = {
    ...
    args: [
        ...
        { name: "syslog", type: "callback", callback: function(v) { logger.setSyslog(v || 1, this.name) }, descr: "Log messages to syslog, pass 0 to disable, 1 or url (tcp|udp|unix):[//host:port]/path?[facility=F][&tag=T][&retryCount=N]...", pass: 1 },
...
core.init = function(options, callback)
{
    ...
    lib.series([
        ...
        function(next) {
            ...
            core.preloadPackages.forEach(function(pkg) {
                try {
