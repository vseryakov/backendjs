...
var core = {
    ...
    args: [ { name: "help", type: "callback", callback: function() { this.showHelp() }, descr: "Print help and exit" },
            ...
            { name: "npm-packages", type: "list", array: 1, descr: "NPM packages to load on startup, the modules, locales, viewes, web subfolders from the package will be added automatically to the system paths, modules will be loaded if present, the config file in etc subfolder will be parsed if present", pass: 1 },
...
core.init = function(options, callback)
{
    ...
    lib.series([
        ...
        function(next) {
            core.npmPackages.forEach(function(pkg) {
                try {
