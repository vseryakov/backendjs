    ...
    for (let i = 0; i < argv.length; i++) {
        ...
        mod.args.forEach(function(x) {
            ...
            try {
                ...
                if (typeof x.onupdate == "function") x.onupdate.call(mod, val, o);
            } catch(e) {
...
// automatically.
//
// Each module is put in the global `core.modules`` object by name, the name can be a property `name` or the module base file name. If a module
// has property `alias` it is used as another entry in the `core.modules` pointing to the same module object.
//
...
core.loadModules = function(dir, options, callback)
{
    ...
    lib.findFileSync(path.resolve(dir), { depth: 1, types: "f", include: /\.js$/ }).sort().forEach(function(file) {
        try {
            ...
            if (mod.alias) modules[mod.alias] = mod;
