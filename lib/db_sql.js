...
db.sqlValue = function(value, type, dflt, min, max)
{
    ...
    switch ((type || lib.typeName(value))) {
    case "expr":
    case "buffer":
        return value;
    ...
    case "float":
    case "double":
        return lib.toNumber(value, { float: true, dflt: dflt, min: min, max: max });
    ...
    case "number":
    case "counter":
        return lib.toNumber(value, { dflt: dflt, min: min, max: max });
