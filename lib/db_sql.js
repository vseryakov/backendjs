...
db.sqlQuery = function(client, req, options, callback)
{
...
db.sqlWhere = function(table, query, keys, options)
{
    ...
    if (Array.isArray(query)) {
        ...
        return query.map(function(x) { return "(" + keys.map(function(y) { return y + "=" + self.sqlQuote(self.getBindValue(table, options, x[y], cols[y])) }).join(" AND ") + ")" }).join(" OR ");
    }
