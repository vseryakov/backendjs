...
db.sqlInitPool = function(options)
{
    ...
    pool.updateAll = function(table, query, obj, options, callback) {
        var req = self.prepare("update", table, query, obj, corelib.extendObj(options, "keys", Object.keys(obj)));
        self.query(req, options, callback);
    }
    pool.delAll = function(table, query, options, callback) {
        var req = self.prepare("del", table, query, corelib.extendObj(options, "keys", Object.keys(query)));
        self.query(req, options, callback);
    }
...
db.sqlFilter = function(columns, values, params)
{
    ...
    for (var name in columns) {
        ...
        if (typeof value =="undefined" || (typeof value == "string" && !value)) {
            // Required field is missing, return empty query
...
db.sqlUpdate = function(table, obj, options)
{
    ...
    if (corelib.isObject(options.expected) && !options.ifExpected) {
