...
Pool.prototype.query = function(client, req, options, callback)
{
        ...
        for (var p in req.obj) {
            ...
            if (o.params && o.type == "object") {
                ...
                for (const p2 in o.params) {
                    const f = o.params[p2];
                    const t = this.configOptions.typesMap[f.type] || this.configOptions.defaultType;
                ...
                const t = o.join ? "text" : this.configOptions.typesMap[o.type] || this.configOptions.defaultType;
    ...
    case "updateall":
        path = req.table + "/_update_by_query";
