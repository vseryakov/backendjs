...
db.SqlPool.prototype.configure = function(options)
{
    if (!this.configOptions.sql) lib.objExtend(this.configOptions, db.sqlConfigOptions);
    db.Pool.prototype.configure.call(this, options);
}
