...
class DbPool extends lib.Pool {
    ...
    constructor(options, defaults)
    {
        ...
        this.configOptions = lib.extend({}, defaults?.configOptions);
        this.connectOptions = lib.extend({}, defaults?.connectOptions);
        this.dbcolumns = {};
        this.dbkeys = {};
        this.dbindexes = {};
        this.dbcapacity = {};
    ...
    configure(options)
    {
        ...
        lib.extend(this.configOptions, options?.configOptions);
        lib.extend(this.connectOptions, options?.connectOptions);
