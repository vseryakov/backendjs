...
//  Example:
//
//        db.clearQuery("bk_user", req.query)
//        db.clearQuery("bk_user", req.query, "internal")
//        db.clearQuery("bk_user", req.query, { filter: "internal" })
//        db.clearQuery("bk_user", req.query, { filter: ["internal"] })
//        db.clearQuery("bk_user", req.query, { filter: ["!pub"] })
//        db.clearQuery("bk_user", req.query, { filter: ["internal","priv"] })
//        db.clearQuery("bk_user", req.query, { filter: ["internal","!priv"], keep: /^__/ })
//        db.clearQuery({ name: {}, id: { admin: 1 } }, req.query, { filter: ["internal"] })
//
db.clearQuery = function(table, query, options)
{
    ...
    var keep = options.keep && util.types.isRegExp(options.keep) ? options.keep : null;
    var clear = options.clear && util.types.isRegExp(options.clear) ? options.clear : null;
    if (!filter) {
