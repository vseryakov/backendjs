...
db.existsTable = function(table, options)
{
    ...
    return this.getPool(options).dbcolumns[table] ? true : false;
}
...
{
    table = this.table(table);
    return this.tables[table] || lib.empty;
}
...
{
    return this.getColumns(table, options)[this.table(name)] || lib.empty;
}
