...
module.exports = {
    ...
    args: [
        ...
        { name: "([a-z0-9]+)-options$", obj: "_config.$1", type: "map", merge: 1, onupdate: "applyOptions", descr: "Additional parameters for drivers, specific to each implementation", example: "-queue-redis-options count:10,interval:100" },
        { name: "([a-z0-9]+)-options-(.+)", obj: "_config.$1", make: "$2", camel: '-', autotype: 1, onupdate: "applyOptions", descr: "Additional parameters for drivers, specific to each implementation", example: "-queue-default-options-count 10" },
    ...
    modules: [
        ...
        require(__dirname + "/queue/eventbridge"),
        require(__dirname + "/queue/json"),
    ],
