...
api.iconPath = function(id, options)
{
    ...
    return this.normalize(core.path.images, options.prefix || "user", num.substr(-2), num.substr(-4, 2), name);
}
...
// Store an icon for user, the options are the same as for the `iconPath` method
