...
{
    var h = req.headers[this.csrfHeaderName] || req.query[this.csrfHeaderName] || req.body[this.csrfHeaderName];
...
api.setCsrfToken = function(req)
{
    ...
    var age = this.csrfAge || this.sessionAge, opts = [lib.uuid(), Date.now() + age];
    ...
    req.res.cookie(this.csrfHeaderName, req.csrfToken, { httpOnly: true, sameSite: "strict", maxAge: age, secure: this.sessionSecure });
