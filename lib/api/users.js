 ...
 * @param {function(err, user)} callback returning found record
 ...
 * @param {object} [options]
 * @param {function(err, user)} callback returning new user record
 * @memberof module:api/users
 * @method add
 */
 ...
 * @param {object} query
 * @param {object} [options]
 * @param {function(err, user)} callback returning updated user record
 * @memberof module:api/users
 * @method update
 */
