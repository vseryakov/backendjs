 ...
 * @return {object} an error object or validated query object as { err, query }
 * @example
 *
 * const { err, query } = lib.validate(req.context.body, {
 *        id: { type: "int" },
...
lib.validate = function(query, schema, options)
{
    ...
    var rc = Object.create(null), opts, dopts, dflts, p, n, v, e, required = [];
