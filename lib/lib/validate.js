 ...
 * @property {boolean} [no_regexp] - validate the input against this regexp and return an error if matched, for list type skip items matched
...
lib.validate = function(query, schema, options)
{
    ...
    var data = Object.create(null), opts, dopts, dflts, p, n, v, e, old, required = [];
    ...
    for (const name in schema) {
        ...
        if (v === undefined || (opts.dflt_empty && this.isEmpty(v))) v = opts.dflt;
        ...
        case "map":
            ...
            v = v.map((x) => (lib.split(x, opts.separator || /[:;]/, opts))).
                  reduce((a, b) => {
                      ...
                      if (opts.map_type) a[b[0]] = lib.toValue(a[b[0]], opts.map_type, opts);
                      return a;
                  }, Object.create(null));
        ...
        default:
            ...
            if (opts.no_regexp) {
                const rx = lib.isArray(opts.no_regexp, [opts.no_regexp]);
