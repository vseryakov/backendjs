...
//  - depth - how deep nested objects can be copied, default is 5
//
//
//       var o = lib.objExtend({ a:1, b:2, c:3 }, { c:5, d:1, _e: 4, f: 5, x: 2 }, { allow: /^(c|d|_e)/, remove: /^_/, del: /^f/ })
//       o = { a:1, b:2, c:5, d:1, e:4 }
//
lib.objExtend = function(obj, val, options, __depth)
{
        ...
        if (options) {
            ...
            for (let p in val) {
                ...
                if (options.deep) {
                    ...
                    case "object":
                        if (__depth >= (options.depth || 5)) continue;
                        this.objExtend(obj[p], v, options, lib.toNumber(__depth) + 1);
                        continue;
                    case "array":
                    ...
                    case "object":
                        if (__depth >= (options.depth || 5)) continue;
                        obj[p] = this.objExtend(obj[p], v, options, lib.toNumber(__depth) + 1);
                        continue;
                    case "array":
                        obj[p] = [];
                        obj[p].push.apply(obj[p], Array.isArray(v) ? v : [v]);
...
{
    return this.objExtend(this.objExtend({}, obj), val, options);
}
