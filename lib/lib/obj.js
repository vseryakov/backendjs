...
//
//
//       lib.objExtend({ a:1, c:5 }, { c: { b: 2 }, d: [{ d: 3 }], _e: 4, f: 5, x: 2 }, { allow: /^(c|d|_e)/, remove: /^_/, del: /^f/ })
//       { a: 1, c: { b: 2 }, d: [ { d: 3 } ], e: 4 }
//
//       lib.objExtend({ a:1, c:5 }, { c: { b: 2 }, d: [{ d: 3 }], _e: 4, f: 5, x: 2 }, { allow: /^(c|d|_e)/, remove: /^_/, del: /^f/, deep: 1 })
//       { a: 1, c: {}, d: [ { d: 3 } ], e: 4 }
//
