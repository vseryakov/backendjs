...
lib.toValue = function(val, type, options)
{
    ...
    case "map":
        return lib.strSplit(val, options && options.delimiter || ",").
               map((y) => (lib.strSplit(y, options && options.separator || /[:;]/, options))).
...
// Parse data as config format name=v alue per line, return an array of arguments in comand line format ["-name", value,....]
