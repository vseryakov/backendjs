...
lib.toParams = function(query, schema, options)
{
    ...
    for (const name in schema) {
        ...
        case "obj":
            if (!v && !opts.empty) break;
            e = this.toParams(v || lib.empty, opts.params, { prefix: options?.prefix, dprefix: options?.dprefix, defaults: dflts });
        ...
        case "object":
            ...
            if (opts.params) {
                e = this.toParams(v, opts.params, { prefix: options?.prefix, dprefix: options?.dprefix, defaults: dflts });
                if (typeof e == "string") return onError(opts, name, v, e);
                v = e;
            }
            if (opts.max > 0 && lib.objSize(v) > opts.max) {
        ...
        case "json":
            ...
            if (opts.params) {
                const e = this.toParams(v, opts.params, { prefix: options?.prefix, dprefix: options?.dprefix, defaults: dflts });
                if (typeof e == "string") return onError(opts, name, v, e);
                v = e;
            }
            ...
            if (v.length || options.keepempty) {
                if (options.__depth >= depth) {
                    ...
                    if (typeof options.__depth != "number") {
                        options = lib.clone(options, { __depth: 0 });
                    }
