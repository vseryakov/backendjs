...
{
    if (!name || lib.badProperties.has(name)) return;
    let preset = lib._jsonFormatPresets[name];
    if (!preset) {
        preset = lib._jsonFormatPresets[name] = Object.create(null);
    }
...
lib.jsonFormat = function(obj, options)
{
    ...
    if (!options.__preset) {
        ...
        const preset = Object.assign(Object.create(null), lib._jsonFormatPresets.default, ...presets.map((x) => (lib._jsonFormatPresets[x])));
