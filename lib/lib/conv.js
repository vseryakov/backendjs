 ...
 * const flags = ["admin"];
 * lib.toFlags("add", flags, ["active", "admin"]);
 * // flags => ["admin", "active"]
 *
 * @example
 * // Update flags: add new ones and remove names prefixed with "-"
 * const flags = ["admin", "active"];
 * lib.toFlags("update", flags, ["verified", "-active"]);
 * // flags => ["admin", "verified"]
 *
 * @example
 * // Filter flags
 * lib.toFlags("present", ["admin", "active", "verified"], ["admin", "verified"]);
 * // => ["admin", "verified"]
 *
 * lib.toFlags("absent", ["admin", "active", "verified"], ["active"]);
 * // => ["admin", "verified"]
 */
