...
lib._epoch = Date.UTC(2025, 11, 15);
lib._epoch_usec = lib._epoch * 1000.0;
lib._epoch_sec = lib._epoch/1000;

/**
 * Returns current time in seconds (s), microseconds (m), time struct (tm) or milliseconds since the local `lib._epoch` (2025-11-15 UTC)
 * @memberof module:lib
 * @method localEpoch
 */
