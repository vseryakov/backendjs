...
lib.processStats = function()
{
    ...
    return {
        ...
        pmem: Math.round(process.memoryUsage.rss()/1024),
        cpu: lib.toNumber(cpu, { digits: 2 }),
        mem: Math.round((os.totalmem() - os.freemem())/1024),
