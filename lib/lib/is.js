 ...
 * this way is more practival and does check and return in one call. While it guaranteese to return object or undefined without default,
 * it returns the `dflt` as is which means it can be any value.
 * @param {any} val
...
/**
 * @param {any} val
 * @param {any} dflt=NaN - default value if not valid or any other value even if not a number
...
/**
 * Safe wrapper for testing for a string type, always returns a string, itself or empty, dflt may return any value
 * @param {string} val
 * @param {any} [dflt=""] - default value if not valid
 * @return {string|any} the string value itself or empty string if not a string
 * @memberof module:lib
 * @method isString
 * @example
 * lib.isString("hello");
...
/**
 * Safe wrapper for testing for and returning function type, returns itself or undefined, dflt can be any value
 * @param {string} func
 ...
 * @param {any[]} val
 * @param {any} [dflt] - default value if not valid
 * @return {any[]|undefined} return the array if the value is non empty array or dflt value if given or undefined
 * @memberof module:lib
 * @method isArray
 * @example
 * lib.isArray([1, 2, 3]);
