...
{
    return typeof val === "number" && !Number.isNaN(val) ? val : Number.NaN;
}
...
/**
 * @param {RegExp} rx
 * @param {any} dflt -return if not a valid RegExp
