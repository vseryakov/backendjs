...
lib.JWT = {
    ...
    * @param {string} [options.alg=HS256] - algorithm to check, ignore alg from header
    ...
    */
    ...
    {
        const { alg = "HS256", iss, nbf = true, exp = true, iat = true, aud } = options || lib.empty;
     ...
     * @async
     */
    importPrivateKey(key, algorithm)
    {
