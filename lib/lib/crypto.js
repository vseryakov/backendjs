...
lib.base32ToHex = function(base32)
{
    var bits = "", hex = "";
    for (let i = 0; i < base32.length; i++) {
        bits += this.base32.indexOf(base32.charAt(i).toUpperCase()).toString(2).padStart(5, '0');
    }
