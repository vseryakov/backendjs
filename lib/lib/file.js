...
/**
 * Safe path.normalize, no exceptions, removes invalid characters `% \ .. : \x0 - \x19`
 * making path safe but non-existent, does not support `..`
 * @param {...any} args
 * @memberof module:lib
 * @method normalize
 * @example
 * > lib.normalize("/usr/www/root", "../%2e%2e//../etc/......./\r\necho/./pas\1swd\00.0\x00.exe")
