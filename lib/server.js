    ...
    if (lib.isArg("-master") && !lib.isArg("-no-master")) {
        ...
        return core.init(opts, (err, opts) => {
            if (cluster.isMaster) {
                ...
                if (process.env.BKJS_WORKER_TYPE == "api") {
                    this.startWeb(opts);
                } else {
        ...
        core.runMethods("configureMaster", options, { direct: 1 }, () => {
            ...
            if (core.isOk("web")) {
                ...
                for (let i = 0; i < this.workers; i++) {
                    var child = cluster.fork({ "BKJS_WORKER_TYPE": "api" });
                    child.worker_type = "api";
                }
...
server.startWeb = function(options)
{
    ...
    logger.log('startWeb:', core.role, 'id:', core.workerId || process.pid, 'version:', core.version, 'home:', core.home, 'port:', core.port, core.bind, 'repl:', core.repl.portWeb, 'uid:', lib.getuid(), 'app:', core.appName, core.runMode, core.instance);
}
...
server.startWorker = function(options)
{
    ...
    core.runMethods("configureWorker", options, { direct: 1 }, () => {
        ...
        logger.log('startWorker:', 'id:', core.workerId || process.pid, 'version:', core.version, 'home:', core.home, 'uid:', lib.getuid(), 'app:', core.appName, core.runMode, core.instance);
    });
}
