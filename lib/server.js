...
server.start = function()
{
    ...
    if (lib.isArg("-master") && !lib.isArg("-no-master")) {
        var opts = { role: cluster.isMaster ? "master" : "worker", localTables: cluster.isMaster && !lib.isArg("-db-create-tables"), noLocales: 1 };
        return core.init(opts, function(err, opts) {
    ...
    if (lib.isArg("-web") && !lib.isArg("-no-web")) {
        var opts = { role: cluster.isMaster ? "server" : "web", localTables: cluster.isMaster && !lib.isArg("-db-create-tables"), noLocales: 1 };
        return core.init(opts, function(err, opts) {
