        ...
        setInterval(() => {
            ...
            for (var i in cluster.workers) {
                ...
                if (t >= 0 && now - t > this.pingInterval) {
                    logger.error("initServer:", core.role, "dead worker detected", w.id, w.process.pid, w.taskName, "interval:", this.pingInterval, "last ping:", now - t, "started:", now - w.startTime);
