...
function Ipc()
{
    ...
    this.args = [
        ...
        { name: "(cache|queue)(-([a-z0-9]+)?-?options)-(.+)$", obj: "configParams.$3", make: "$4", camel: '-', autotype: 1, onparse: function(v,o) {this.parseOptions(v,o)}, onupdate: function(v,o) {this.applyOptions(v,o)}, descr: "Additional parameters for clients, specific to each implementation, ex: `-ipc-queue-options-count 10`" },
        { name: "(cache|queue)-([a-z0-9]*)-options$", obj: "configParams", make: "$2", type: "map", merge: 1, maptype: "auto", onparse: function(v,o) {this.parseOptions(v,o)}, onupdate: function(v,o) {this.applyOptions(v,o)}, descr: "Additional parameters for clients, specific to each implementation, ex: `-ipc-queue--options count:10,interval:100" },
    ];
}
