...
Ipc.prototype.handleServerMessages = function(worker, msg)
{
    ...
    try {
        ...
        case 'cache:get':
            if (Array.isArray(msg.name)) {
                ...
                for (var i = 0; i < msg.name.length; i++) {
                    msg.value.push(bkcache.lruGet(msg.name[i], msg.now));
                }
            } else
            if (msg.name) {
        ...
        case 'cache:del':
            if (Array.isArray(msg.name)) {
                for (var i in msg.name) bkcache.lruDel(msg.name[i]);
            } else {
...
//
// If `options.set` is given and no value exists in the cache it will be set as the initial value, still
...
Ipc.prototype.subscribe = function(channel, options, callback)
{
    ...
    try {
        this.getClient(null, options).subscribe(channel, options, callback);
    } catch(e) {
...
Ipc.prototype.unsubscribe = function(channel, options, callback)
{
    ...
    try {
        this.getClient(null, options).unsubscribe(channel, options, callback);
    } catch(e) {
...
Ipc.prototype.publish = function(channel, msg, options, callback)
{
    ...
    try {
        this.getClient(null, options).publish(channel, msg, options, callback);
    } catch(e) {
...
Ipc.prototype.listen = function(options, callback)
{
    ...
    try {
        this.getClient(null, options).listen(options, callback);
    } catch(e) {
...
Ipc.prototype.unlisten = function(channel, options, callback)
{
    ...
    try {
        this.getClient(null, options).unlisten(channel, options, callback);
    } catch(e) {
...
Ipc.prototype.submit = function(msg, options, callback)
{
    ...
    try {
        this.getClient(null, options).submit(msg, options, callback);
    } catch(e) {
...
{
    try {
        this.getClient("queue", options).unlock(name, options);
    } catch(e) {
