...
Ipc.prototype.unlisten = function(options, callback)
{
    if (typeof options == "function") callback = options, options = null;
    logger.dev("ipc.unlisten:", options);
    try {
        this.getClient(null, options).unlisten(options, typeof callback == "function" ? callback : undefined);
    } catch (e) {
        logger.error('ipc.unlisten:', options, e.stack);
    }
    return this;
}
