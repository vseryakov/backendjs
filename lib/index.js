...
exports.pool = require(__dirname + '/util/pool');
exports.lru = require(__dirname + '/util/lru');
exports.JWT = require(__dirname + '/util/jwt');
exports.metrics = require(__dirname + '/metrics');
exports.httpGet = exports.modules.fetch = require(__dirname + '/httpGet');
...
exports.ahttpGet = exports.modules.ahttpGet = function(uri, params)
{
    return new Promise((resolve, reject) => {
        exports.httpGet(uri, params, (err, req) => {
