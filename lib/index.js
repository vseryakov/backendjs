...
exports.image = require(__dirname + '/util/image');
exports.color = require(__dirname + '/util/color');
exports.webscraper = require(__dirname + '/util/webscraper');
...
const mods = [
    ...
    "/api/users", "/api/passkey", "/api/ws", "/api/static",
];
