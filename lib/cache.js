...
mod.astats = promisify(mod.stats.bind(mod));
...
mod.aclear = promisify(mod.clear.bind(mod));
...
mod.aget = promisify(mod.get.bind(mod));
...
mod.adel = promisify(mod.del.bind(mod));
...
//    Returns total number of items in the list after the operation.
//
// Example:
//
//       cache.put("my:key", 2)
...
//       cache.put("", [1,2,3], { listName: "my:list" }, (err, total) => {})
//
...
mod.aput = promisify(mod.put.bind(mod));
...
mod.aincr = promisify(mod.incr.bind(mod));
...
mod.alimiter = promisify(mod.limiter.bind(mod));
...
mod.acheckLimiter = promisify(mod.checkLimiter.bind(mod));
...
mod.alock = promisify(mod.lock.bind(mod));
...
mod.aunlock = promisify(mod.unlock.bind(mod));
