...
var aws = {
    ...
    args: [ { name: "key", descr: "AWS access key" },
            ...
            { name: "ddb-shard-retry-timeout", type: "int", min: 50, descr: "DynamoDB Streams timeout in ms between retries on empty records, exponential backoff is used" },
            { name: "ddb-shard-retry-max-timeout", type: "int", min: 50, descr: "DynamoDB Streams max timeout in ms on empty records" },
