...
aws.configureServer = function(options, callback)
{
    ...
    lib.everyParallel([
        ...
        function(next) {
            ...
            this.queryELB2("DescribeTargetGroups", { "TargetGroupArns.member.1": aws.targetGroup }, (_err, rc) => {
...
aws.shutdown = function(_options, callback)
{
...
/**
 * AWS AIM API request, async version
 * @memberof module:aws
 * @method aqueryIAM
 * @async
 */
aws.aqueryIAM = async function(action, obj, options)
{
...
/**
 * AWS STS API request, async version
 * @memberof module:aws
 * @method aquerySTS
 * @async
 */
aws.aquerySTS = async function(action, obj, options)
{
