...
IpcSQSClient.prototype.submit = function(msg, options, callback)
{
    ...
    if (options && (options.region || options.delay)) opts = lib.objMerge(this.options, options);
    aws.sqsSendMessage(this.url, new Buffer(lib.stringify(obj)).toString("base64"), opts, callback);
}
