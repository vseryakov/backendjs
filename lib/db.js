...
module.exports = {
    ...
    args: [
        ...
        { name: "cache2-(.+)", obj: "cache2", type: "int", no_camel: 1, min: 0, descr: "Tables with TTL for level2 cache, i.e. in the local process LRU memory. It works before the primary cache and keeps records in the local LRU cache for the given amount of time, the TTL is in ms and must be greater than zero for level 2 cache to work" },
