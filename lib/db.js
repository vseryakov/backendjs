...
const LRUCache = require(__dirname + '/util/lru');
const fs = require("fs");
 ...
 * @property {boolean} api.admin -  a generic read permission requires `options.isAdmin` when used with `api.cleanResult`
 * @property {boolean} api.staff -  a generic read permission requires `options.isStaff` when used with `api.cleanResult`
 * @property {boolean} api.internal -  if set then this property can only be updated by admin/root or with `isInternal`` property
 * @property {string|string[]} api.roles -  a role or a list of roles which further restrict access to a public column to only users with specified roles
 * @property {string|string[]} api.noroles -  a role or a list of roles which excplicitely deny access to a column for users with specified roles
