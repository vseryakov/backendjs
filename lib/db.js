...
const db = {
    ...
    args: [
        ...
        { name: "([a-z0-9]+)-pool-options", obj: '_config.$1.configOptions', type: "map", merge: 1, onupdate: "applyPoolOptions", descr: "General options for a DB pool" },
 ...
 *
 *  @example
 *  var ops = [ { table: "bk_counter", obj: { id:1, like:1 } },
...
{
    if (typeof options == "function") callback = options,options = null;
    var req = this.prepare("create", table, schema, options);
...
{
    if (typeof options == "function") callback = options,options = null;
    var req = this.prepare("upgrade", table, schema, options);
    this.query(req, req.options, callback);
}
