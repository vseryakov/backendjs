...
var db = {
    ...
    arrayOps: ["in","not in","not_in","between","not between","not_between"],
...
//      as `options.updateProcess(row, options)`
...
//    in case of complex columns that may contain concatenated values as in the case of using DynamoDB. The callback will be called
//    as `options.delProcess(row, options)`
...
// Return list of selected or allowed only columns, empty list if no `options.select` is specified or it is equal to `*`
