 ...
 * @property {any} dflt - default value to return if not retrieved
 ...
 * @property {boolean} keyword - a hint to treat the value as it is in search (Elasticsearch)
 ...
 * @property {string[]|object} [join] - make this a part of joined(composite) column
 * @property {string[]} join.name - a list with property names that must be joined together before performing a db operation,
 ...
 * @property {boolean} join.strict - can be used to perform join only if all columns in the list are not empty, so the join
 *   is for all columns or none
 * @property {boolean} join.all - can be used to proceed and join empty values, without it the any join stops on first empty value but
 ...
 * @property {boolean} join.force - can be used to force the join regardless of the existing value, without it if the existing value contains the
 *   separator it is skipped
 * @property {boolean} join.hash - can be used to store a hash of the joined column to reduce the space and make the result value easier to use
 * @property {boolean} join.lower - convert the joined value to lower case
 * @property {boolean} join.upper - convert the joined value to upper case
 * @property {boolean} join.cap -  capitalize words
 * @property {function} join.format - a function(req, value, obj, col) - must return a value to be used, the value is joined already
 * @property {object} [custom] - database specific instructions to apply when creating a table or column
