...
db.copy = function(table, query, options, callback)
{
    ...
    lib.series([
        function(next) {
            if (!(options.region || options.file) && db.getPool(table, qopts) == db.getPool(table, uopts)) {
                ...
                if (qopts.batch) {
                    lib.series([
                        ...
                        function(next3) {
                            ...
                            if (options.file) {
                                return fs.appendFile(options.file, rows.map((x) => (lib.stringify(x.obj))).join("\n") + "\n", next3);
                            }
                    ...
                    lib.series([
                        ...
                        function(next3) {
                            ...
                            if (options.file) {
                                return fs.appendFile(options.file, lib.stringify(row) + "\n", next3);
                            }
