 ...
 *
 * @property {object} api - API access permisions used by {@link module:db.cleanupResult}
 * @property {boolean} api.pub - make a column as public, always return,
 ...
 * @property {boolean} api.admin - a generic read permission requires __req.options.isAdmin__ when used with {@link module:db.cleanupResult}
 * @property {boolean} api.staff - a generic read permission requires __req.options.isStaff__ when used with {@link module:db.cleanupResult}
...
module.exports = {
    ...
    args: [
        ...
        { name: "cleanup-rules-(.+)", obj: "cleanup.rules.$1", type: "map", merge: 1, nocamel: 1, descr: "Rules for the db.cleanupResult per table", example: "db-cleanup-rules-bk_user = email:0,phone:1" },
        { name: "cleanup-strict", obj: "cleanup", type: "bool", descr: "Default strict mode for cleanup results" },
...
db.init = function(options, callback)
{
    ...
    var pools = db.none ? [] : Object.keys(db._config).filter(x => !lib.includes(this.skip?.pools, x));
