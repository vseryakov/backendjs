 ...
 *  - __ttl__ -  save as timestamp in ms in the future to be expired by database (DynamoDB),  the value is added to current time
 *  - __timeout__ - save as timestamp in the future in ms, current time plus the value
