...
//
//          db.get("bk_user", { login: "123" }, { pool: "pg" }, function(err, row) {
...
const db = {
    ...
    args: [{ name: "pool", dns: 1, descr: "Default pool to be used for db access without explicit pool specified" },
           ...
           { name: "aliases-(.+)", obj: "aliases", nocamel: 1, lower: 1, descr: "Table aliases to be used instead of the requested table name" },
