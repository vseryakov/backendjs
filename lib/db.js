...
const db = {
    ...
    args: [{ name: "pool", dns: 1, descr: "Default pool to be used for db access without explicit pool specified" },
           ...
           { name: "describe-column-([a-z0-9_]+)-([a-z0-9_]+)", obj: "columns.$1", make: "$2", type: "map", maptype: "auto", descr: "Describe a table column properties, can be a new or existing column, overrides existing property, ex: -db-describe-column-bk_user-name max:255", },
