 ...
 *  - __text, varchar, str, string, keyword__ -  text types
 ...
 *  - __set__ - a unique set of string or numbers if supported natively, otherwise same as list
 ...
 *  - __now__ -  defines a column to be automatically filled with the current timestamp in milliseconds
