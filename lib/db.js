...
var db = {
    ...
    args: [{ name: "pool", dns: 1, descr: "Default pool to be used for db access without explicit pool specified" },
           ...
           { name: "create-table-roles", type: "list", pass: 1, descr: "Only processes with these roles can create tables" },
           ...
           { name: "([a-z0-9]+)-pool-(tables)$", obj: 'poolParams.$1.configOptions', make: "$2", type: "list", descr: "Tables to be created only in this pool, to prevent creating all tables in every pool" },
