 ...
 * - ``` id: { type: "text", index: 1, _$dynamodb: { projections: ["name"], global: 1 } }```
 ...
 *
 * DynamoDB projections are defined by the `_$dynamodb.projections[N]` property in the first index property
