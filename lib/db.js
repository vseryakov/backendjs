...
function queryEnd(err, req, rows, callback)
{
    ...
    if (err) {
        ...
        logger.logger(req.options.logger_error || "error", "queryEnd:", req.pool, err, 'REQ:', req.op, req.table, req.obj, req.text, req.values, 'OPTS:', req.options, "I:", req.info, "F:", req.failed);
    } else {
...
db.adellAll = function(table, query, options)
{
    return new Promise((resolve, reject) => {
