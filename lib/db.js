...
const db = {
    ...
    args: [{ name: "pool", dns: 1, descr: "Default pool to be used for db access without explicit pool specified" },
           ...
           { name: "([a-z0-9]+)-pool-options$", obj: 'poolParams.$1', type: "map", make: "configOptions", maptype: "auto", merge: 1, onparse: function(v,o) {this.parsePoolOptions(v,o)}, onupdate: function(v,o) {this.applyPoolOptions(v,o)}, descr: "General options for a DB pool" },
