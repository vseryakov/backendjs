...
const db = {
    ...
    args: [
        ...
        { name: "([a-z0-9]+)-pool-(skip-tables)$", obj: 'poolParams.$1.configOptions', make: "$2", array: 1, type: "list", descr: "Tables not to be created in this pool" },
        { name: "([a-z0-9]+)-pool-(metric-tables)$", obj: 'poolParams.$1.configOptions', make: "$2", array: 1, type: "list", descr: "Tables to collect metrics in this pool" },
