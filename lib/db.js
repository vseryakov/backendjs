 ...
 * @property  {boolean} options.quiet - report errors in debug level
 ...
 * @property  {boolean} options.nopreparerow - if true skip row preparation and columns processing, the req.obj is passed as is, useful for syncing between pools
 ...
 * @property  {boolean} options.info_obj - to return the record just processed in the info object as `obj` property, it will include all generated and updated columns
 * @property  {boolean} options.result_obj - to return the query record as result including all post processing and new generated columns, this is not what `returning` property does, it only
 *      returns the query record with new columns from memory
 * @property  {boolean} options.keep_req - on return do not clear out the request object, by default all properties are deleted to free up memory
 * @property  {boolean} options.keep_obj - only preserve op, obj, table properties in the reqest after return
 ...
 * @property {DBColumn} name1 - column1
 * @property {DBColumn} name2 - column2
 * @property {DBColumn} ... - more columns
 */

/**
 * Database column definition
 * @typedef {object} DBColumn
 ...
 *  - `list, set` -  store a list of primitive types, strings and/or numbers
 ...
 *  - `uuid, tuuid, suuid, sfuuid` -  autogenerate the column value with UUID,
 ...
 * @property  {int} unique -  column is part of an unique key, the number defined the order if it is  composite key
 * @property  {int} index -  column is part of an index, the value is a number for the column position in the index
 * @property  {int} indexN -  additonal inxdexes where N is 1..5
 * @property  {any} value -  default value for the column
 * @property  {int} len -  column length
 ...
 * @property  {int} maxlist -  max number of items in the `list` or `array` column types
 * @property  {boolean} pub - make a column as public, *this is very important property because it allows anybody to see it when used in the default API functions, i.e. anybody with valid
 ...
 * @property  {boolean} hidden -  completely ignored by all update operations but could be used by the public columns cleaning procedure, if it is computed and not stored in the db
 ...
 * @property  {string} prefix -  prefix to be prepended for autogenerated columns: `uuid`, `suud`, `tuuid, sfuuid`
 ...
 * @property  {boolean} notempty -  do not allow empty columns, if not provided it is filled with the default value
 ...
 * @param {DBTable} columns - an object with table schema
 * @param {object} [options] - options for the database driver
