...
const db = {
    ...
    args: [{ name: "pool", dns: 1, descr: "Default pool to be used for db access without explicit pool specified" },
           ...
           { name: "unknown-tables", type: "bool", descr: "Allow to operate unknown tables, by default only tables described in the `db.tables` can be used" },
...
db.select = function(table, query, options, callback)
{
    ...
    if ((options?.cacheKey || options?.cacheKeyName) && !options.__cached && !options.nocache) {
        this.getCached("select", table, query, options, callback);
    }
