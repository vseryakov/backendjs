...
const DbColumnType = {
    ...
    /** generates a random number in {@link module:db.add}/{@link module:db.put} methods, uses optional .max/.min properties */
    random: "random",
    ...
    /** defines a column to be automatically filled with the current timestamp in milliseconds */
    now: "now",

    /** defines a column that will be automatically incremented by the {@link module:db.incr} command, on creation it is set with 0 */
    counter: "counter",
};
 ...
 * @property {DbColumnType|String} type - column type, supported types: {@link DbColumnType}
