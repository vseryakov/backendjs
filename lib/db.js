...
module.exports = {
    ...
    args: [
        ...
        { name: "aliases-(.+)", obj: "aliases", nocamel: 1, reverse: 1, onparse: function(v,o) { o.name=this.table(o.name); return this.table(v) }, descr: "Table aliases to be used instead of the requested table name, only high level db operations will use it, low level utilities use the real table names" },
...
function queryResult(req, rows, callback)
{
    ...
    lib.series([
        function(next) {
            ...
            switch (req.op) {
            case "bulk":
                let options = req.options, skipped = 0;
...
db.queryProcessSync = function(pool, req, _row)
{
    ...
    case "del":
        ...
        let table = req.op === "bulk" ? req.query[0]?.table : req.table;
