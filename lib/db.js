 ...
 *    - expr - full set SQL expression as is or can be an array of values with
 *       elememt 0 being the expression with the rest as values: ["name=COALESCE(name,$1)||$2", 'N/A', ' jr']
 *
 ...
 * { tag_$expr: ["tag=COALESCE(name,$1)||count", "N/A"] }
 * ```
