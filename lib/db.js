...
var db = {
    ...
    args: [{ name: "pool", dns: 1, descr: "Default pool to be used for db access without explicit pool specified" },
           ...
           { name: "allow-column-(.+)", obj: "allowColumn", nocamel: 1, strip: /allow-column-/, descr: "A column that is allowed to be used in any table, the name is a regexp with the value to be a type", },
...
{
    for (var p in this.allowColumn) {
        var col = this.allowColumn[p];
