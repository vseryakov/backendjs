...
//
// On return the second arg to the callback is a list of records with errors, same input record with added property `status`
//
// Example
//
//          var ops = [ { op: "add", table: "bk_counter", obj: { id:1, like:1 } },
...
db.convertRows = function(pool, req, rows, options)
{
    ...
    var i, col, cols = req.columns || this.getColumns(req.table, req.options || options);
