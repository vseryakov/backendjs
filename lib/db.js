...
db.updateAll = function(table, query, obj, options, callback)
{
    ...
    var filter = options && typeof options.updateFilter == "function" ? options.updateFilter : null;
    ...
    this.scan(table, query, options, function(row, next) {
        ...
        db[options && options.op || "update"](table, row, uoptions, function(err) {
            if (!err) nupdated++;
...
db.delAll = function(table, query, options, callback)
{
    ...
    var ignore_error = options && options.ignore_error;
    var filter = options && typeof options.delFilter == "function" ? options.delFilter : null;
