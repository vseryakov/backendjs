...
class Push extends EventEmitter {
    ...
    constructor() {
        ...
        this.args = [
            { name: "config", obj: "_config", type: "json", merge: 1, descr: 'An object with client configs", example: "-push-config {"wp":{"type":"wp",key":XXX","pubkey":"XXXX"}}' },
            { name: "([a-z0-9]+)", obj: "_config.$1", type: "map", merge: 1, descr: "A client parameters", example: "-push-wp type:wp,key:K,pubkey:PK,email:XXX" },
        ];
