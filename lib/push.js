...
class Push extends EventEmitter {
    ...
    constructor() {
        ...
        this.args = [
            ...
            { name: "([a-z0-9]+)", obj: "_config.$1", type: "map", merge: 1, maptype: "auto", descr: "A client parameters, ex: `-push-wp type:wp,key:K,pubkey:PK,email:XXX`" },
    ...
    *  - user_id - an user id associated with this token, for debugging and invalid token management
