...
core.watchLogs = function(options, callback)
{
    ...
    if (Date.now() - this.logwatcherMtime < this.logwatcherInterval * 1000) return lib.tryCall(callback);
...
{
    var opts = { match: {}, ignore: {}, once: {}, seen: {}, errors: {}, counter: {}, last_chan: "", last_line: 0, last_pos: {} };
    ...
    this.modules.db.select("bk_property", { name: 'logwatcher:' }, { ops: { name: 'begins_with' }, fullscan: 1, pool: this.logwatcherPool || this.modules.db.local }, (err, rows) => {
