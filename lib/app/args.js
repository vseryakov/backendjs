 ...
 *  `role, roles, tag, instance, version, config, arch, host, platform, env`
 *
 * @example
 *
 * [instance.type=]
...
{
    var context = ["role", "roles", "tag", "instance", "version", "config", "arch", "host", "platform" ].reduce((a, b) => {
...
app.processArg = function(options)
{
    ...
    try {
        ...
        // Autodetect type
        if (o.autotype && val) {
            type = o.autotype[o.name] || lib.autoType(val) || type;
        }
