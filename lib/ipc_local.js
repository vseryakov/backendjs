...
{
    var self = this;
    core.modules.ipc.sendMsg("queue:pop", channel, options, function(msg) {
        self.emit(channel, msg.value, function(err) {
            setTimeout(self.startListening.bind(self, channel), self.options.timeout * 1000);
        });
    });
}
...
{
    core.modules.ipc.sendMsg("queue:push", channel, msg, options, function(msg) {
