...
aws.ddbProcessShardRecords = function(shard, options, processcallback, callback)
{
    lib.everySeries([
        function(next) {
            ...
            processcallback("shard-start", shard, options, next);
        },
        function(next, err) {
        ...
        function(next, err, it) {
            if (err || !it || !it.ShardIterator) return next();
        ...
        function(next) {
            processcallback("shard-end", shard, options, next);
        },
    ], callback);
}
...
aws.ddbProcessStreamShards = function(stream, options, processcallback, callback)
{
    lib.everySeries([
        function(next) {
            processcallback("stream-start", stream, options, next);
        },
        function(next, err) {
            if (err) return next(err);
        ...
        function(next) {
            processcallback("stream-end", stream, options, next);
        },
    ], callback);
}
