...
core.describeArgs("aws", [
    ...
    { name: "ddb-shard-retry-count", type: "int", min: 1, descr: "DynamoDB Streams retry count before exiting processing a shard with empty records" },
