...
{
    if (!this.quiet) logger[this.retryCount ? "debug" : "error"]("httpError:", core.role, err, this.toJSON(), typeof this.postdata == "string" ? this.postdata.substr(0, 256) : "");
...
HttpRequest.prototype.onEnd = function(res, callback)
{
    ...
    if ((this.status < 200 || this.status >= 400) &&
        ...
        this.retryCount-- > 0) {
        if (!this.quiet) logger.debug("httpRetry:", core.role, this.toJSON(), typeof this.postdata == "string" ? this.postdata.substr(0, 256) : "");
        setTimeout(httpGet.bind(null, this.uri, this, callback), this.retryTimeout *= 2);
        return;
    }
...
HttpRequest.prototype.toJSON = function()
{
    return {
        ...
        file: this.file || "",
        date: this.date,
        location: this.resheaders.location || "",
    };
}
