...
class SQSQueueClient extends QueueClient {
                ...
                if (msg.noWaitTimeout > 0) {
                    ...
                    if (vtimeout) {
                        ...
                        if (msg.visibilityTimeout > 0) {
                            aws.querySQS("ChangeMessageVisibility", req, this.options);
                        }
                        vtimer = setInterval(() => {
                            if (done) return;
    ...
    drop(msg, options, callback) {
        ...
        aws.querySQS("DeleteMessage", { QueueUrl: this.url, ReceiptHandle: msg.__queueMessageId }, this.options, callback);
    }
