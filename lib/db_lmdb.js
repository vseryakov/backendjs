...
db.lmdbInitPool = function(options)
{
    ...
    pool.getLevelDB = function(callback) {
        ...
        try {
            ...
            new utils.LevelDB(path, this.settings, function(err) {
                pool.dbhandle = this;
                callback(null, this);
            });
        } catch(e) {
    ...
    pool.getLMDB = function(callback) {
        ...
        try {
            ...
            if (!this.settings.flags) this.settings.flags = utils.MDB_CREATE;
            ...
            if (this.settings.env && this.settings.env instanceof utils.LMDBEnv) this.env = this.settings.env;
            if (!this.env) this.env = new utils.LMDBEnv(this.settings);
            new utils.LMDB(this.env, { name: this.url, flags: this.settings.flags }, function(err) {
                pool.dbhandle = this;
                callback(err, this);
            });
        } catch(e) {
