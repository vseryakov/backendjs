...
HttpRequest.prototype.onEnd = function(res, callback)
{
    ...
    if (this.data && !this.noparse) {
        ...
        case "application/json":
            this.obj = lib.jsonParse(this.data, { datatype: this.datatype, logger: this.datalogging });
            break;

        case "text/xml":
        case "application/xml":
            this.obj = lib.xmlParse(this.data, { datatype: this.datatype, logger: this.datalogging });
            break;
        }
    }
