...
Pool.prototype.doQuery = function(method, path, postdata, query, options, callback)
{
    ...
    core.httpGet(opts.nodeHost + opts.nodePath, opts, function(err, params) {
        logger.logger(options.logger_db || "debug", "elasticsearchQuery:", params.elapsed, 'ms', opts, "hits:", params.obj && params.obj.hits && params.obj.hits.hits.length, err);
...
Pool.prototype.getGeoQuery = function(table, query, options)
{
    ...
    var n = options.latlon_name || db.getFilteredColumns(table, { type: "geopoint" }, { list: 1 })[0] || "latlon";
        ...
        query: {
            bool: {
                ...
                filter: {
                    geo_distance: {
                        distance: d,
                        [n]: lib.isArray(options.latlon) ? options.latlon : [options.longitude, options.latitude]
                    }
                }
            }
        },
