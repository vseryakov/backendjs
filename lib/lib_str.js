...
// - `options.keepempty` - will preserve empty items, by default empty is ignored
//
...
lib.strSplit = function(str, sep, options)
{
    ...
    return (Array.isArray(str) ? str : (typeof str == "string" ? str : String(str)).split(sep || this.rxSplit)).
            map((x) => {
